...
SSM_MODEL_VERSION_ARN=$(aws ssm get-parameter --name "/fund/equitypricemodel/model_version" --query "Parameter.ARN" --output text 2>/dev/null || echo "")
if [ -n "$SSM_MODEL_VERSION_ARN" ]; then
