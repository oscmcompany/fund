...
use tide_model::config::ModelParameters;
use tide_model::data::{FeatureMappings, Scaler};
use tide_model::model::TideModel;
...
impl Metrics {
    ...
    pub fn increment_requests(&self) {
        self.prediction_requests_total.fetch_add(1, Ordering::Relaxed);
    }
    ...
    pub fn render_prometheus(&self, load_timestamp: i64, artifact_key: &str) -> String {
        ...
        output.push_str("# HELP ensemble_prediction_requests_total Total prediction requests received\n");
        ...
        output.push_str("# HELP ensemble_prediction_errors_total Total prediction requests that failed\n");
        ...
        output.push_str("# HELP ensemble_prediction_duration_seconds Time to generate predictions end-to-end\n");
        ...
        output.push_str("# HELP ensemble_prediction_batch_count Number of batches in last prediction run\n");
        ...
        output.push_str("# HELP ensemble_prediction_row_count Number of prediction rows in last run\n");
        ...
        output.push_str("# HELP ensemble_model_load_timestamp Unix timestamp of last successful model load\n");
